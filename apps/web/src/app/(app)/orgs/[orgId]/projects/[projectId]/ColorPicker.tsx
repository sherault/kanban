...
export const PRESET_COLORS = [
  '#f3f4f6', '#fef2f2', '#fef9c3', '#f0fdf4',
  '#eff6ff', '#f5f3ff', '#fdf4ff', '#fff7ed',
  '#fecaca', '#fde68a', '#a7f3d0', '#bfdbfe',
  '#c4b5fd', '#f9a8d4', '#fed7aa', '#a5f3fc',
]
    ...
    <div className="flex flex-wrap gap-1.5 items-center">
      ...
      <button
        ...
        className={`w-6 h-6 rounded border-2 bg-white flex items-center justify-center leading-none ${
          value === null ? 'border-blue-500' : 'border-gray-200 hover:border-gray-400'
        }`}
      >
      ...
      <div className="relative w-6 h-6">
        ...
        >
          {!isCustom && <span className="text-gray-400 text-xs leading-none">+</span>}
        </button>
        <input
          ref={customRef}
          type="color"
